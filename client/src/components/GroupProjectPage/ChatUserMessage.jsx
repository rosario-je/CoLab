...
export const ChatUserMessage = ({ message }) => {
  ...
  return (
    <div className="chat chat-start px-4">
      ...
      <div className="flex flex-row chat-header font-semibold pb-2 items-end text-text-color">
      ...
      <div className="chat-bubble"><p className="text-2xl bg-menu-colors">{message.message}</p></div>
    </div>
  );
};
