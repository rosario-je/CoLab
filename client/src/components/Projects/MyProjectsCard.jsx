...
// THIS WILL BE THE FILE FOR SPECIFICALLY THE USER'S PROJECTS ONLY WHERE THEY CAN EDIT OR COMPLETE THEIR PROJECTS
// WHEN PUSHING UP THE CHANGES FOR THE PROJECT CARD: Just swap the code from that file to this one
// This file contains the original code for the project card
