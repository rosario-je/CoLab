...
export const JoinRequestListItems = ({
  ...
  return (
    <>
      <div className="card bg-navbar-color text-neutral-content w-11/12 my-10 border-2 border-project-border/25">
          ...
          <div className="card-actions w-full justify-between self-end">
            ...
            <div className="flex justify-center items-center gap-[15px]">
              <button
                ...
                className="btn bg-confirm hover:bg-confirm-light text-white rounded-full border-none"
              >
                Accept
              </button>

              <button onClick={denyRequest} className="btn bg-reject hover:bg-reject-light text-white rounded-full border-none">
                Deny
              </button>
            </div>
          </div>
